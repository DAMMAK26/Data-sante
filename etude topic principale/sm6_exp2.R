...
# Pour sm3
per_class_acc_sm3 <- extract_per_class_accuracy(results_sm1, "sm3")
print(per_class_acc_sm3)

# Pour sm2a
per_class_acc_sm2a <- extract_per_class_accuracy(results_sm1, "sm2a")
print(per_class_acc_sm2a)

# Pour sm2b
per_class_acc_sm2b <- extract_per_class_accuracy(results_sm1, "sm2b")
print(per_class_acc_sm2b)

# Pour sm2c
per_class_acc_sm2c <- extract_per_class_accuracy(results_sm1, "sm2c")
